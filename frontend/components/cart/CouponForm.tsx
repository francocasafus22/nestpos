  ...
  return (
    <>
      ...
      <form className="flex " onSubmit={(e) => handleSubmit(e)}>
        <input
          type="text"
          className="p-2 bg-gray-200 border-gray-300 w-full rounded-l-lg"
          placeholder="Ingresa un cupón"
          name="coupon_name"
        />
        <input
          type="submit"
          className="p-3 bg-green-400  font-bold hover:cursor-pointer rounded-r-lg"
          value="Canjear"
        />
      </form>
